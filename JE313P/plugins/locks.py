...
@JE313P.on(events.NewMessage(pattern="^[!?/]قفڵ ?(.*)"))
@is_admin
...
async def unlock(event, perm):
    ...
    if "پەیامەکان" in input_str:
       ...
       await event.reply("وینه چوڵاوه کان کرایەوە")
    elif "ڕێڕەوکردن" in input_str:
