...
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
بۆ بینینی فەرمانە تایبەتەکان کلیک لە خوارەوە بکە. 
[𖠄 𝗝𝗲𝗽𝘁𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 𖠄](https://t.me/Trpay_dllm)
"""
...
async def _(event):
    if event.is_private:
       await event.edit(PM_START_TEXT.format(event.sender.first_name), buttons=[
        [Button.url("➕ بۆ ئادم کلیک لێرە بکە", f"https://t.me/{BOT_USERNAME}?startgroup=true")],
        [Button.url("خاوه ن بۆت", "https://t.me/SARKAUT")],
        [Button.url("پشتگتری", f"https://t.me/{Config.SUPPORT}"), Button.url("كه نال", f"https://t.me/{Config.CHANNEL}")],
        [Button.inline("فه رمانه کان", data="help")]])
       return
